...
extension View {
    func innerShadow<S: Shape, SS: ShapeStyle>(shape: S, color: SS, lineWidth: CGFloat = 1, offsetX: CGFloat = 0, offsetY: CGFloat = 0, blur: CGFloat = 4, blenMode: BlendMode = .normal, opacity: Double = 1) -> some View {
        return self
            .overlay {
                shape
